...
public class Inscrit_Main extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inscrit_main);
        ...
        getSupportFragmentManager().beginTransaction()
                ...
                .replace(R.id.fragmentContainer, Inscrit_Home_Page.class, null)
                .commit();
        ...
        NotifLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedTab != 2) {
                    ...
                    getSupportFragmentManager().beginTransaction()
                            .setReorderingAllowed(true)
                            .replace(R.id.fragmentContainer, Inscrit_Tchat_Home.class, null)
                            .commit();
    ...
    void setCreateConversation() {
        getSupportFragmentManager().beginTransaction()
                .setReorderingAllowed(true)
                .replace(R.id.fragmentContainer, Inscrit_Tchat_New.class, null)
                .commit();
    ...
    void setConversation(String userName, String name, String conversationId) {
        ...
        getSupportFragmentManager().beginTransaction()
                .setReorderingAllowed(true)
                .replace(R.id.fragmentContainer, Inscrit_Tchat_Click.class, bundle)
                .commit();
