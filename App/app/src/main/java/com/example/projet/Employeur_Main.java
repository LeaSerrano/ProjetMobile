...
public class Employeur_Main extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.employeur_main);
        ...
        getSupportFragmentManager().beginTransaction()
                        .setReorderingAllowed(true)
                                .replace(R.id.fragmentContainer, Employeur_Home_Fragment.class,null)
                                        .commit();
        ...
        NotifLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(selectedTab != 2){
                    ...
                    getSupportFragmentManager().beginTransaction()
                            .setReorderingAllowed(true)
                            .replace(R.id.fragmentContainer, Employeur_Tchat_Home.class,null)
                            .commit();
    ...
    void setCreateOffer() {
        getSupportFragmentManager().beginTransaction()
                .setReorderingAllowed(true)
                .replace(R.id.fragmentContainer, Employeur_Home_Ajout_Offre.class, null)
                .commit();
    ...
    void setCreateConversation() {
        getSupportFragmentManager().beginTransaction()
                .setReorderingAllowed(true)
                .replace(R.id.fragmentContainer, Employeur_Tchat_New.class, null)
                .commit();
    ...
    void setConversation(String userName, String name, String conversationId) {
        ...
        getSupportFragmentManager().beginTransaction()
                .setReorderingAllowed(true)
                .replace(R.id.fragmentContainer, Employeur_Tchat_Click.class, bundle)
                .commit();
